...
public class StringMethod {
    ...
    public static void main(String[] args) {
        ...
        //charAt() -> retyrn the character at the specific index value
        char a=s.charAt(0);
        ...
        //trim()-> removes white space from boyh ends of a string
        System.out.println(s.trim());
        //length()-> return the length of a value
        System.out.println(s.length());
        //stratsWith()->ckecks whether a string starts with specified character
